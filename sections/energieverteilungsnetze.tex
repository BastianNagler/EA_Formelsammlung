...
\subsubsection{Spannungen und Str\"ome in DS}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.95\columnwidth]{./Bilder/Energieverteilungsnetze/DS_Allgemein.png}
        \includegraphics[width=0.95\columnwidth]{./Bilder/Energieverteilungsnetze/Zeigerdiagramme.png}
    \end{figure}
...
\subsubsection{Einphasiges ESB (symmetrisch)}
    ...
    \textbf{Dreieck-Stern-Umwandlung (symmetrisch)}
    \begin{flalign*}
        Z_Y &= \frac{Z_\Delta}{3} &
    \end{flalign*}
...
\begin{itemize}
    \item \textbf{Offene Netze: } einseitig gespeiste Leitung
    \item \textbf{Strahlnetz: } einseitig gespeiste Leitung mit Verzweigungen
    \item \textbf{Zweiseitig gespeiste Leitung}
