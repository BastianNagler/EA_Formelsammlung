...
\subsubsection{Leistungsgleichgewicht}
    {\small
        ...
        \begin{align*}
            W_{m_zu} = W_{el_ab} \quad ; \quad P_{m_zu} = P_{el_ab}
        \end{align*}
        \underline{Kopplung zwischen Leistung und Drehzahl}
        \begin{gather*}
        \omega_{el} = p \cdot \omega_{m} \\
        2 \pi f = p \cdot 2 \pi \cdot n \rightarrow f = p \cdot n 
        \end{gather*}

        \begin{itemize}
            \item n = mechanische Drehzahl [1/s]
            \item p = Polpaarzahl der Maschine
            \item f = elektrische Frequenz [Hz]
        \end{itemize}
